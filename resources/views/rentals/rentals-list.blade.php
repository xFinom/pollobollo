...
<header class="page" style="background-image: url('{{asset('images/header.jpeg')}}');">
    <div class="container">
        <div class="page_title">
            ...
            <h1 class="page_title-title outlined outlined--white" data-aos="fade-left">Renta de Botargas</h1>
            <h2 class="page_title-subtitle" data-aos="fade-left" data-aos-delay="50">
                Lleva a tus personajes favoritos a tus fiestas
            </h2>
        </div>
    </div>
</header>
                            ...
                            <div class="main">
                                <div class="main_header">
                                    ...
                                    <div class="price h4 d-flex">
                                        <span class="price_item price_item">$ {{$articulo->rent_price}} MXN</span>
                                    </div>
                                </div>
                                <div class="main_footer">
                                    ...
                                    <div class="wrapper d-flex">
                                        <a class="btn btn--black btn--shop addToCart" href="{{ route('contratacion-renta', ['botarga' => $articulo]) }}">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (successMessage) {
            Swal.fire({
                icon: 'success',
                title: '¡Pago Exitoso!',
                text: 'Revisa tu correo para tu comprobante',
            });
        }
    });
</script>
