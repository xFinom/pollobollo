...
<head>
    <meta charset="UTF-8">
    <!--Esta linea es para que se pueda ajustar la vista a un celular-->
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <!--Este es para hacerlo compatvle con edge-->
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title>Pollobollo</title>
...
<body class="text-gray-600 work-sans leading-normal text-base tracking-normal bg-text-yellow-200">

<!--Nav-->
<nav id="header" class="w-full z-30 top-0 py-1" style="background-color: #FF3733">
    <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-3">
        ...
        <div class="hidden md:flex md:items-center md:w-auto w-full order-3 md:order-1" id="menu">
            <nav>
                <ul class="md:flex items-center justify-between text-base text-yellow-200 pt-4 md:pt-0">
                    <li><a href=""><img src="{{asset('imagenes/logo.png')}}" class="h-10 w-16"/></a></li>
                    <li><a class="inline-block no-underline hover:text-yellow-200 hover:underline py-1 px-2" href="#">Shows</a></li>
                    <li><a class="inline-block no-underline hover:text-yellow-200 hover:underline py-1 px-2" href="#">Botargas</a></li>
                    <li><a class="inline-block no-underline hover:text-yellow-200 hover:underline py-1 px-2" href="#">Paquetes</a></li>
                </ul>
            </nav>
        </div>

        <div class="order-2 md:order-3 flex items-center" id="nav-content">
            <a class="inline-block no-underline hover:text-yellow-200" href="{{ route('dashboard') }}">
                    <svg class="fill-current hover:text-yellow-200" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        ...
        <div class="w-full mx-auto flex flex-wrap">
            <div class="flex w-full lg:w-1/2 ">
                <div class="px-3 md:px-0">
                    <p class="py-0">
                        Somos el mejor espectáculo de Guadalajara para cualquier ocasión, show infantiles y para adultos. ¡Contáctanos!
                    </p>
                </div>
            </div>
            <div class="flex w-full lg:w-1/2 lg:justify-end lg:text-right mt-6 md:mt-0">
                <div class="px-3 md:px-0">
                    <div class="w-full flex items-center py-4 mt-0">
                        <a href="https://x.com/POLLOBOLLOSHOW?s=20" class="mx-2 hover:text-red-500">
                            <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24">
                                <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"></path>
                            </svg>
                        </a>
                        <a href="https://www.facebook.com/payasopollobollodeguadalajara" class="mx-2 hover:text-red-500">
                            <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24">
                                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"></path>
                            </svg>
                        </a>
                        <a href="https://instagram.com/bollos_show?igshid=NGVhN2U2NjQ0Yg==" class="mx-2 hover:text-red-500">
                            <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24">
                        ...
                        <a href="https://wa.me/3314397435?text=¡Agenda%20tu%20show%20con%20nosotros%20en%20Pollo%20Bollo!" class="mx-2">
