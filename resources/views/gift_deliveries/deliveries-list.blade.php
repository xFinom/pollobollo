...
<header class="page" style="background-image: url('{{asset('images/header.jpeg')}}');">
    <div class="container">
        <div class="page_title">
            ...
            <h1 class="page_title-title outlined outlined--white" data-aos="fade-left">Entrega de Regalos</h1>
            <h2 class="page_title-subtitle" data-aos="fade-left" data-aos-delay="50">
                Recibe un regalo de tu personaje favorito
            </h2>
        </div>
    </div>
</header>
                            ...
                            <div class="main">
                                <div class="main_header">
                                    ...
                                    <div class="price h4 d-flex">
                                        <span class="price_item price_item">$ {{$articulo->gift_price}} MXN</span>
                                    </div>
                                </div>
                                <div class="main_footer">
                                    ...
                                    <div class="wrapper d-flex">
                                        <a class="btn btn--black btn--shop addToCart" href="{{ route('contratacion-regalo', ['regalo' => $articulo]) }}">
